...
if __name__ == "__main__":
    # 클래스 선언
    classifier = BernouliNBClass({'subject': 'a', 'classifier_algorithm': 'c', 'model_save': 'aaa', 'learning_column': 'STT_CONT', 'prediction_column': 'CALL_L_CLASS_CD'}, 'refined_call_112.csv')
