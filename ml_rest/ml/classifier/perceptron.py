...
class PerceptronClass:
    ...
    def make_feature_data(self, config):
        ...
        for key, value in cat_dict.items():
            ...
            cat_dict[key] = sorted(value.items(), key=(lambda x: x[1]), reverse=True)[:10]
...
if __name__ == "__main__":
    # 클래스 선언
    classifier = PerceptronClass({'subject': 'a', 'classifier_algorithm': 'c', 'model_save': 'aaa', 'learning_column': 'TALK', 'prediction_column': 'NICKNAME'}, 'result_3000.csv')
