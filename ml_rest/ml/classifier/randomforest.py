...
if __name__ == "__main__":
    # 클래스 선언
    classifier = RandomForestClass({'subject': 'a', 'classifier_algorithm': 'c', 'model_save': 'aaa', 'learning_column': 'TALK', 'prediction_column': 'NICKNAME'}, 'result_3000.csv')
